...
export default function Sidebar() {
  return (
    <div className="flex">
      <div className="flex flex-col h-screen bg-white fixed z-20 shadow w-60">
        <div className="w-1/2 pt-5 pb-10">
          <img src={logo} />
        </div>
        <div className="w-full flex pt-10">
          <ul className="pt-2 pb-4 w-full">
            <li className="rounded-md pb-4">
              <Link
                aria-selected="true"
                // color={"black"}
                underline="none"
                href="#"
                className="flex gap-4 items-center p-2 rounded-md hover:bg-blue-400 bg-blue-300"
              >
                <HomeOutlinedIcon />
                <p className="font-bold text-lg">Homepage</p>
              </Link>
            </li>
            <li className="rounded-md pb-4">
              <Link
                ...
                underline="none"
                href="#"
                className="flex gap-4 items-center p-2 rounded-md hover:bg-blue-400 "
              >
            ...
            <li className="rounded-md pb-4">
              ...
              >
                ...
                <p className="font-bold text-lg">Purchase</p>
              </Link>
            </li>
            <li className="rounded-md pb-4">
              <Link
